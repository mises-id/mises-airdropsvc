...
func FindChannelUser(ctx context.Context, params ISearchParams) (*ChannelUser, error) {
...
func ListChannelUser(ctx context.Context, params ISearchParams) ([]*ChannelUser, error) {
...
func preloadChannelUser(ctx context.Context, channel_users ...*ChannelUser) error {
	...
	users, err := socialModel.FindUserByIDs(ctx, userIds...)
	if err != nil {
		return err
	}
	userMap := make(map[uint64]*socialModel.User)
...
func CountChannelUser(ctx context.Context, params ISearchParams) (int64, error) {
