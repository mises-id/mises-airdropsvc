...
func FindUserTwitterAuth(ctx context.Context, params ISearchParams) (*UserTwitterAuth, error) {
...
func ListUserTwitterAuth(ctx context.Context, params ISearchParams) ([]*UserTwitterAuth, error) {
...
func CountUserTwitterAuth(ctx context.Context, params ISearchParams) (int64, error) {
